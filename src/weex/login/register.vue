<template>
    <div style="flex-direction: column; background-color: white">
        ...
        <div style="flex-direction: row; height: 149px; ">
            ...
            <input type="number" v-model="account" placeholder="输入用户名" placeholder-color="#B8BDCD" singleline="true" style="margin-left: 31px;font-size: 32px; color:#333333;flex: 1;margin-top:77px;margin-right: 20px; height: 44px"/>
        </div>
        ...
        <div style="flex-direction: row; height: 131px; ">
            ...
            <input type="password" v-model="pwd" placeholder="输入密码" placeholder-color="#B8BDCD" singleline="true" style="margin-left: 31px;font-size: 32px; color:#333333;flex: 1;margin-top:30px;margin-right: 20px"/>
        </div>
        <div style="margin-left: 60px; margin-right: 60px;height: 1px; background-color: #F1F1F1"></div>
